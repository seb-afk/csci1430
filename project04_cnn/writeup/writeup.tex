...
\begin{itemize}
  ...
  \item Show and discuss the results of your algorithm, and include pictures where possible.
  \item Feel free to include code snippets, images, and equations.
  \item Use as many pages as you need, but err on the short side. If you feel you only need to write a short amount to meet the brief, that is fine.

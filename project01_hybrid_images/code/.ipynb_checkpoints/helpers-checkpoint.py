...
def my_imfilter(image, filter):
  ...
  # In case we have a grayscale image we add a dimension so that we do not get errors.
  ...
  img_conv = np.array(result).reshape(image.shape)
  img_conv = img_conv.astype(int)

  filtered_image = img_conv
  # TODO support grayscale and color images
  # TODO support arbitrary shaped odd dimension filers
  # TODO raise exception for even filters
  # TODO return identical image with identity filter
  # TODO return image that has the same resolution as the input 
